...
<head>
    <meta charset="UTF-8">
    <meta property="og:title" name="og:title" content="CRep Panel | Technothlon"/>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a href="{{ route('crepregs') }}">
                        <i class="fa fa-table"></i> <span>Registrations</span>
                    </a>
                </li>
                <li class="treeview">
                    <a href="{{ route('crepuploadreg') }}">
                        <i class="fa fa-upload"></i> <span>Upload</span>
                    </a>
                </li>
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-bank"></i> <span>Centres</span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu" style="display: none;">
                        <li><a href="{{ route('crepcentres') }}"><i class="fa fa-circle-o"></i> Details</a></li>
                        <li><a href="{{ route('crepallotcentres') }}"><i class="fa fa-circle-o"></i> Allot</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="{{ route('creponspot') }}">
                        <i class="fa fa-street-view"></i> <span>On-Spot</span>
                    </a>
                </li>
                <li class="treeview">
                    <a href="{{ route('crepdown') }}">
