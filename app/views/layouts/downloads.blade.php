...
@section('title')
Technothlon | Downloads
@endsection
@section('head')
<link rel="stylesheet" type="text/css" href="{{ asset('sprites/download.css') }}">
@endsection
@section('Description')
...
@section('body')
<div class="container">
            <div class="sprite-download download-logo logo"></div>
            <div class="sprite-download download-title title"></div>
            <h1 style="text-align: center">
                <a target="_blank"
                   href="https://drive.google.com/folderview?id=0B5-GsYZi9MQFeW9MUVFoRnh6M2M&usp=sharing">
                    <span style="color: #d03100">Previous Years' Question Papers</span>
                </a>
            </h1>
            ...
            <div style="text-align: center">
                <a target="_blank" href="https://drive.google.com/folderview?id=0B5-GsYZi9MQFeW9MUVFoRnh6M2M&usp=sharing">
                    <span style="color: #d03100">Download All</span>
                </a>
            </div>
            <br>
        </div>
