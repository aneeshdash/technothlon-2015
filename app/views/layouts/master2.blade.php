...
<div id="view-port">
    ...
    <div class="nav-wrapper" style="height: 73px;">
        <div class="nav node hide-on-phone" style="height: 73px;float: left; margin-top: 10px; max-width: 8%;margin-right: 1%">
            <a class="nav fade" href="http://robomart.com" target="_blank">
                <div>
                    <img src="{{ asset('images/partners/logo-robomart.png') }}" style="max-width: 100%">
                        <p style="margin-top: -60px;text-align: right; font-size: 10px">presents</p>
                </div>
            </a>
        </div>
        <div class="nav node hide-on-phone" style="height: 73px;float: left;max-width: 12%; margin-right: 2%">
            <a class="nav fade" href="{{ route('home') }}">
                <div style="height: 73px">
                    <img src="{{ asset('images/technothlon-nav-logo.png') }}" style="max-width: 100%">
                </div>
            </a>
        </div>
        <div class="nav node hide-on-phone" style="height: 73px; float: right; margin-right: 2%; max-width: 8%; margin-left: 2%">
            <a class="nav fade" href="http://techniche.org/">
                <div style="height: 73px">
                    <img src="{{ asset('images/techniche-nav-logo.png') }}" style="max-width: 100%">
                </div>
            </a>
        </div>
        <div class="nav node hide-on-phone" style="height: 73px; float: right; max-width: 10%;margin-left: 1%">
            <a class="nav fade" href="{{ route('home') }}" target="_blank">
                <div style="height: 73px">
                    <img src="{{ asset('images/technothlon-hindi-logo.png') }}" style="max-width: 100%; margin-top: 8%">
                </div>
            </a>
        </div>
        ...
        <div class="nav node" style="text-align: center"><a class="nav" href="{{ route('contact') }}">Contact Us</a></div>
            ...
            {{--<nav>--}}
                {{--<ul>--}}
                    ...
                    {{--<li><a href="{{ route('home') }}">Technopedia</a></li>--}}
                    {{--<li><a href="{{ route('home') }}">Regisrations</a></li>--}}
                    {{--<li><a href="{{ route('home') }}">LED</a></li>--}}
                    {{--<li>--}}
                        {{--<a href="#">Resourses</a>--}}
                        {{--<ul class="fallback">--}}
