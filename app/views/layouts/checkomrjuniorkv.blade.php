...
<form method="post" action="{{ route('checkomr') }}">
    <input type="text" name="roll" size="10" style="position: absolute; top: 150px; left: 80px;width: 100px" value="{{ $data->roll }}">
    <input type="number" name="mobile" size="10" style="position: absolute; top: 150px; left: 380px;width: 100px" value="{{ $data->mobile }}">
